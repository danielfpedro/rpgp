...
class VersionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_versions_plugins_idx' => ['type' => 'index', 'columns' => ['plugin_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_versions_plugins' => ['type' => 'foreign', 'columns' => ['plugin_id'], 'references' => ['plugins', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-01-25 12:32:57',
            'modified' => '2016-01-25 12:32:57',
